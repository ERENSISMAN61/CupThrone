...
public class MineHealth : NetworkBehaviour, IInteractable
{
    ...
    {
        //Debug.Log($"Mine Interact called. IsServer: {IsServer}, IsClient: {IsClient}, IsHost: {IsHost}");
    ...
    private void ApplyDamage(int damage, ulong clientId)
    {
        ...
        //Debug.Log($"BEFORE: Mine health: {currentHealth.Value}");
        currentHealth.Value -= damage;
        //Debug.Log($"AFTER: Mine took {damage} damage from client {clientId}. Remaining health: {currentHealth.Value}");
